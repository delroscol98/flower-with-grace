        ...
        <section className="mb-10">
          ...
          <article className="flex flex-col gap-10">
            ...
            <p className={`${averageSans.className} text-neutral-white`}>
              Based in North-West Sydney, Flower with Grace is a small yet
              highly dedicated team focused on curating elegant, airy, floral
              designs that reflect your unique love story. At Flower with Grace,
              we work collaboratively with you to help transform your vision
              into reality, working to make sure each floral arrangement
              reflects the utmost love and care that we instill into its design.
            </p>
            ...
            <article className="flex flex-col gap-4">
              ...
              <p className={`${averageSans.className} text-neutral-white`}>
                Get in touch with me today to have a chat about your ideas and
                see how we can transform your vision into reality!
              </p>
            </article>
          </article>
        </section>
